...
const imageCache = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let processedImageName = imagePreProcessor_1.default.imageNameFormatter(req.params.imageName, req.query);
    try {
        if (fs_1.default.existsSync(imagePreProcessor_1.default.processedFileDir + processedImageName)) {
            ...
            res.locals.processedImageName = imagePreProcessor_1.default.processedFileDir + processedImageName;
        }
        else {
            ...
            if (fs_1.default.existsSync(imagePreProcessor_1.default.rawFileDir + rawImageName)) {
                ...
                if ((typeof req.query.height === 'undefined' || req.query.height === null) &&
                    ...
                    if (typeof req.query.height === 'undefined' || req.query.height === null) {
                        ...
                        success = imageProcessor_1.default.resizeImage(imagePreProcessor_1.default.rawFileDir + rawImageName, imagePreProcessor_1.default.processedFileDir + processedImageName, { width: parseInt(req.query.width), height: parseInt(req.query.height) });
                    }
                    if (yield success) {
                        res.locals.processedImageName = imagePreProcessor_1.default.processedFileDir + processedImageName;
                    }
